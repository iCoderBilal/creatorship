...
export function MarqueeDemoVertical() {
  return (
    <div className="relative flex h-[640px] w-full flex-row items-center justify-center overflow-hidden rounded-lg bg-background">
      ...
      {/* <div className="pointer-events-none absolute inset-x-0 top-0 h-1/3 bg-gradient-to-b from-[#1E053D] dark:from-background"></div>
      <div className="pointer-events-none absolute inset-x-0 bottom-0 h-1/3 bg-gradient-to-t from-[#492A70] dark:from-background"></div> */}
    </div>
  );
}
