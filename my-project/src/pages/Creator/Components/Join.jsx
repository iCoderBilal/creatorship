    ...
    <div className="bg-white p-8">
      <div className="max-w-7xl mx-auto py-16">
        <div className="text-left mb-12">
          <h1
            className="text-[9vw] leading-[9.5vw] md:text-[3.5vw] md:leading-[4vw] font-Montserrat font-bold text-black"
            data-aos="fade-up"
            data-aos-delay="100"
          >
            Succeed With{" "}
            <span class="relative inline-block">
              {" "}
              Creatorship
              <span class="absolute bottom-[-10px] left-0 w-full h-1 bg-[#8649D0]"></span>
            </span>
          </h1>
        </div>
        <div className="grid grid-cols-1 md:grid-cols-3 gap-6 mt-16">
          <div className="bg-[#F4F7FA] p-6 shadow-lg rounded-[30px] md:row-span-2 flex justify-center flex-col">
            <h2 className="text-2xl md:text-4xl font-bold mb-3 font-Montserrat">
              Partner with Leading Brands
            </h2>
            <p className="cxobv c6xyh ceonn font-Montserrat text-gray-600 font-medium">
              Get exclusive access to top brands that are eager to hear your
              unique voice. Our partnerships are designed to help you amplify
          ...
          <div className="bg-[#F4F7FA] p-6 shadow-lg rounded-[30px] ">
            ...
            <p className="cxobv c6xyh ceonn font-Montserrat text-gray-600 font-medium">
              Earn directly from your creativity. We facilitate collaborations
